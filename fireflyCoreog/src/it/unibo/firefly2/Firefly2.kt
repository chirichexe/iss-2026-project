	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("flash") { //this:State
					...
					transition(edgeName="t05",targetState="sync_Flash",cond=whenDispatch("sync"))
				}	 
				state("sync_Flash") { //this:State
					...
					sysaction { //it:State
				 	 		stateTimer = TimerActor("timer_sync_Flash", 
				 	 					  scope, context!!, "local_tout_"+name+"_sync_Flash", 1000.toLong() )  //OCT2023
					}	 	 
					 transition(edgeName="t16",targetState="sync_Flash",cond=whenTimeout("local_tout_"+name+"_sync_Flash"))   
				}	 
			}
		}
} 
