		...
		return { //this:ActionBasciFsm
				...
				state("flash") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t07",targetState="flash",cond=whenTimeout("local_tout_"+name+"_flash"))   
					transition(edgeName="t08",targetState="sync_Flash",cond=whenDispatch("sync"))
				}	 
