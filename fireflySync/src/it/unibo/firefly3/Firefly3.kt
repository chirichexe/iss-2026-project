	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("flash") { //this:State
					action { //it:State
						CommUtils.outmagenta("$name | $Timer")
					...
					transition(edgeName="t07",targetState="sync",cond=whenEvent("syncronize"))
				}	 
				state("sync") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("syncronize(TIME,FREQ)"), Term.createTerm("syncronize(TIME)"), 
